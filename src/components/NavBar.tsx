...
const NavBar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b border-white/5 backdrop-blur-lg ${scrolled ? "bg-walker-dark/80" : "bg-walker-dark/50"}`}>
